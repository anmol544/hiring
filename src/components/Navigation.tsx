...
const Search = styled("div")({
  ...
  "@media (max-width: 600px)": {
    // Hide on small screens (max-width: 600px)
    display: "none",
  },
});
...
const Navbar = () => {
  return (
    <AppBar
      position="sticky"
      sx={{ backgroundColor: "#990011", color: "#FFF2D7" }}
    >
      <Toolbar>
        <Container maxWidth="lg">
          <Box
            sx={{
              display: "flex",
              justifyContent: "space-between", // Space between the left and right elements
              alignItems: "center",
            }}
          >
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
              ...
              <Avatar
                ...
                sx={{
                  ...
                  "&:hover": {
                    transform: "scale(1.25)", // Scale the avatar on hover
                  },
                }}
                alt="Anmol Raj"
